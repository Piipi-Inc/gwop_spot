...
**Вопрос 1:**  
*Какие акции IT компаний сейчас наиболее интересны для приобретения?*  
...
**Вопрос 2:**  
*В какие индексные фонды можно вложиться?*  

**Ответ:**  
В предоставленном контексте не упоминаются конкретные индексные фонды, в которые можно вложиться. Однако, в общем случае, инвесторы могут рассмотреть возможность вложения в индексные фонды, которые отслеживают различные рыночные индексы, такие как S&P 500, NASDAQ-100, или индекс Мосбиржи. Рекомендуется провести исследование и выбрать фонды, соответствующие вашим инвестиционным целям и стратегии.

---

**Вопрос 3:**  
*У меня есть 70 тысяч рублей свободных денег в месяц. Хочу купить квартиру в Санкт-Петербурге за 8 миллионов рублей. Ипотечный кредит не рассматриваю из-за высокой ключевой ставки. Рассчитай план по накоплению денег, достаточных для покупки квартиры, используя противоинфляционные инструменты.*

**Ответ:**  
Для накопления 8 миллионов рублей на покупку квартиры в Санкт-Петербурге, при условии, что у вас есть 70 тысяч рублей свободных денег в месяц и вы не рассматриваете ипотечный кредит, можно использовать следующие шаги:

1. **Определите срок накопления**:  
   - Если вы хотите накопить 8 миллионов рублей, при ежемесячном накоплении 70 тысяч рублей, вам потребуется:  
     \[
     \text{Срок} = \frac{8,000,000}{70,000} \approx 114.29 \text{ месяцев} \approx 9.5 \text{ лет}
     \]

2. **Используйте противоинфляционные инструменты**:  
   - Рассмотрите возможность открытия депозитного счета с высокой процентной ставкой (например, 18-20% годовых). Это поможет вам не только сохранить, но и приумножить ваши сбережения.  
   - Пример расчета с использованием 20% годовых:  
     \[
     \text{Сумма через год} = 70,000 \times 12 + \text{проценты}
     \]
     Проценты (приближенно):  
     \[
     0.2 \times \frac{70,000 \times 12}{2} \approx 168,000
     \]
     Итого через год:  
     \[
     840,000 + 168,000 = 1,008,000 \text{ рублей}
     \]

3. **Планируйте регулярные взносы**:  
   - Продолжайте вносить 70 тысяч рублей каждый месяц. С учетом сложных процентов, ваша сумма будет расти быстрее.
   - Используйте калькулятор сложных процентов для более точного расчета.

4. **Корректируйте план**:  
   - Если вы хотите сократить срок накопления, вы можете увеличить ежемесячные взносы, если это возможно.
   - Также следите за изменениями в процентных ставках и ищите более выгодные предложения по депозитам.

5. **Рассмотрите альтернативные инвестиции**:  
   - Если вы готовы к риску, можно рассмотреть инвестиции в фондовый рынок или другие активы, которые могут дать более высокую доходность, чем депозиты.

Таким образом, при текущем уровне накоплений и с учетом противоинфляционных инструментов, вам потребуется около 9.5 лет для накопления 8 миллионов рублей. Однако, с использованием высокодоходных депозитов и возможных инвестиций, этот срок может быть сокращен.
